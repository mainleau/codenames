...
!(function (t, e) {
      ...
      (i = Object.assign
        ...
        : function(t) {
            for (let e = 1; e < arguments.length; e++) {
              const n = arguments[e];
              for (const r in n) Object.hasOwn(n, r) && (t[r] = n[r]);
            }
            return t;
          }),
  ...
  const w = typeof ArrayBuffer === 'function';
  const _ = function(t) {
    return typeof ArrayBuffer.isView === 'function' ? ArrayBuffer.isView(t) : t && t.buffer instanceof ArrayBuffer;
  };
  ...
  for (
    var R = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/',
      T = typeof Uint8Array === 'undefined' ? [] : new Uint8Array(256),
      C = 0;
    C < 64;
    C++
  ) T[R.charCodeAt(C)] = C;
  ...
  const N = function(t, e) {
    if (typeof t !== 'string') return { type: 'message', data: x(t, e) };
    const n = t.charAt(0);
    return n === 'b'
  ...
  var x = function(t, e) {
    return e === 'blob' ? (t instanceof Blob ? t : new Blob([t])) : t instanceof ArrayBuffer ? t : t.buffer;
  };
  const P = String.fromCharCode(30);
  function j(t) {
    if (t) return (function(t) {
        for (const e in j.prototype) t[e] = j.prototype[e];
        return t;
      }(t));
  }
  (j.prototype.on = j.prototype.addEventListener =
    ...
    (j.prototype.emit = function(t) {
      ...
      if (n) {
        r = 0;
        for (let i = (n = n.slice(0)).length; r < i; ++r) n[r].apply(this, e);
      }
      return this;
    }),
  ...
  const q = typeof self !== 'undefined' ? self : typeof window !== 'undefined' ? window : Function('return this')();
  function I(t) {
  ...
  function U(t, e) {
    e.useNativeTimers
      ...
      : ((t.setTimeoutFn = q.setTimeout.bind(q)), (t.clearTimeoutFn = q.clearTimeout.bind(q)));
  }
  let M;
  const V = (function(t) {
    o(i, t);
      ...
      r(i, [
        {
          key: 'onError',
          value(t, e, n) {
            return p(s(i.prototype), 'emitReserved', this).call(this, 'error', new V(t, e, n)), this;
          },
        },
        {
          key: 'open',
        ...
        },
        {
          key: 'onData',
          value(t) {
            const e = N(t, this.socket.binaryType);
            this.onPacket(e);
          },
        },
        {
  ...
  const K = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_'.split('');
  const Y = 64;
  const W = {};
  let z = 0;
  let J = 0;
  ...
  let X = !1;
  try {
    X = typeof XMLHttpRequest !== 'undefined' && 'withCredentials' in new XMLHttpRequest();
  } catch (t) {}
  const G = X;
  function Z(t) {
    const e = t.xdomain;
  ...
  function tt() {}
  const et = new Z({ xdomain: !1 }).responseType != null;
  const nt = (function(t) {
    o(s, t);
    const n = l(s);
    function s(t) {
      let r;
      if ((e(this, s), ((r = n.call(this, t)).polling = !1), typeof location !== 'undefined')) {
        const i = location.protocol === 'https:';
        let o = location.port;
        o || (o = i ? '443' : '80'),
          (r.xd = (typeof location !== 'undefined' && t.hostname !== location.hostname) || o !== t.port);
      }
      const a = t && t.forceBase64;
      return (r.supportsBinary = et && !a), r.opts.withCredentials && (r.cookieJar = void 0), r;
    }
    return (
      r(s, [
        {
        ...
        },
        {
          ...
          value(t) {
            ...
            (function(t, e) {
              ...
              if ((e.readyState === 'opening' && t.type === 'open' && e.onOpen(), t.type === 'close')) return e.onClose({ description: 'transport closed by the server' }), !1;
              e.onPacket(t);
            }),
        ...
        },
        {
          ...
          value() {
            ...
            return i(t, { xd: this.xd, cookieJar: this.cookieJar }, this.opts), new rt(this.uri(), t);
          },
        },
        {
          key: 'doWrite',
      ...
      r(i, [
        {
          ...
          value() {
            ...
            const r = (this.xhr = new Z(n));
            try {
              r.open(this.method, this.uri, !0);
              try {
                if (this.opts.extraHeaders) for (const o in (r.setDisableHeaderCheck && r.setDisableHeaderCheck(!0), this.opts.extraHeaders)) this.opts.extraHeaders.hasOwnProperty(o) && r.setRequestHeader(o, this.opts.extraHeaders[o]);
              } catch (t) {}
              if (this.method === 'POST') {
                try {
              ...
              (t = this.opts.cookieJar) === null || void 0 === t || t.addCookies(r),
                ...
                (r.onreadystatechange = function() {
                  let t;
                  r.readyState === 3 && ((t = e.opts.cookieJar) === null || void 0 === t || t.parseCookies(r)),
                    r.readyState === 4 &&
                      (r.status === 200 || r.status === 1223
                        ? e.onLoad()
                        : e.setTimeoutFn(() => {
                            e.onError(typeof r.status === 'number' ? r.status : 0);
                          }, 0));
                }),
                r.send(this.data);
            } catch (t) {
  ...
  if (((rt.requestsCount = 0), (rt.requests = {}), typeof document !== 'undefined')) {
  ...
  function it() {
    for (const t in rt.requests) rt.requests.hasOwnProperty(t) && rt.requests[t].abort();
  }
  const ot =
  ...
  const st = q.WebSocket || q.MozWebSocket;
  const at =
    ...
    return (
      r(i, [
            ...
            typeof WebTransport === 'function' &&
              ...
              this.transport.ready.then(() => {
                t.transport.createBidirectionalStream().then(e => {
                  ...
                  !(function e() {
                    r.read()
                      .then(r => {
                        ...
                        const o = r.value;
                        i ||
                          (n || o.byteLength !== 1 || o[0] !== 54
                            ? (t.onPacket(
                                (function(t, e, n) {
                                  B || (B = new TextDecoder());
                                  const r = e || t[0] < 48 || t[0] > 54;
                  ...
                  const i = t.query.sid ? '0{"sid":"'.concat(t.query.sid, '"}') : '0';
                  t.writer.write(new TextEncoder().encode(i)).then(() => t.onOpen());
                });
              }));
          },
        },
            ...
            for (
              var n = function() {
                  ...
                  !(function(t, e) {
                    ...
                    (function(t, e) {
                      return t.type === 'message' && typeof t.data !== 'string' && e[0] >= 48 && e[0] <= 54;
                    }(n, t)) && e.writer.write(Uint8Array.of(54)),
                      e.writer.write(t).then(() => {
                        i &&
                          ot(() => {
                            (e.writable = !0), e.emitReserved('drain');
                          }, e.setTimeoutFn);
        ...
        },
        {
          ...
          value() {
            let t;
            (t = this.transport) === null || void 0 === t || t.close();
          },
        },
      ]),
      i
  ...
  const ht = { websocket: ct, webtransport: ut, polling: nt };
  const ft =
  ...
  function pt(t) {
    ...
    for (var i, o, s = ft.exec(t || ''), a = {}, c = 14; c--;) a[lt[c]] = s[c] || '';
    return (
      n != -1 &&
        r != -1 &&
        ((a.source = e),
  ...
  const dt = (function (n) {
    ...
    function a(n) {
      ...
      return (
        ...
        U(f(r), o),
        (r.secure = o.secure != null ? o.secure : typeof location !== 'undefined' && location.protocol === 'https:'),
        o.hostname && !o.port && (o.port = r.secure ? '443' : '80'),
        (r.hostname = o.hostname || (typeof location !== 'undefined' ? location.hostname : 'localhost')),
        (r.port =
          o.port || (typeof location !== 'undefined' && location.port ? location.port : r.secure ? '443' : '80')),
          ...
          value(t) {
            ...
            this.transport && this.transport.removeAllListeners(),
              ...
              t
                ...
                .on('close', t => e.onClose('transport close', t));
          },
        },
        {
          key: 'probe',
  ...
  const yt = typeof ArrayBuffer === 'function';
  const vt = function(t) {
  ...
  const mt =
    typeof Blob === 'function' || (typeof Blob !== 'undefined' && gt.call(Blob) === '[object BlobConstructor]');
  const bt =
    typeof File === 'function' || (typeof File !== 'undefined' && gt.call(File) === '[object FileConstructor]');
  function kt(t) {
    return (yt && (t instanceof ArrayBuffer || vt(t))) || (mt && t instanceof Blob) || (bt && t instanceof File);
  }
  function wt(e, n) {
    if (!e || t(e) !== 'object') return !1;
    if (Array.isArray(e)) {
      for (let r = 0, i = e.length; r < i; r++) if (wt(e[r])) return !0;
      return !1;
    }
    if (kt(e)) return !0;
    if (e.toJSON && typeof e.toJSON === 'function' && arguments.length === 1) return wt(e.toJSON(), !0);
    for (const o in e) if (Object.hasOwn(e, o) && wt(e[o])) return !0;
    return !1;
  }
  function _t(t) {
    const e = [];
  ...
  function Ot(e, n) {
    ...
    if (Array.isArray(e)) {
      for (var i = new Array(e.length), o = 0; o < e.length; o++) i[o] = Ot(e[o], n);
      return i;
    }
    if (t(e) === 'object' && !(e instanceof Date)) {
      const s = {};
      for (const a in e) Object.hasOwn(e, a) && (s[a] = Ot(e[a], n));
      return s;
    }
    return e;
  }
  ...
  function Et(e, n) {
    ...
    if (e && !0 === e._placeholder) {
      if (typeof e.num === 'number' && e.num >= 0 && e.num < n.length) return n[e.num];
      throw new Error('illegal attachments');
    }
    if (Array.isArray(e)) for (let r = 0; r < e.length; r++) e[r] = Et(e[r], n);
    else if (t(e) === 'object') for (const i in e) Object.hasOwn(e, i) && (e[i] = Et(e[i], n));
    return e;
  }
  let Rt;
      ...
      r(t, [
        ...
        },
        {
          ...
          value(t) {
            let e = `${t.type}`;
            return (
              (t.type !== Rt.BINARY_EVENT && t.type !== Rt.BINARY_ACK) || (e += `${t.attachments}-`),
              t.nsp && t.nsp !== '/' && (e += `${t.nsp},`),
              t.id != null && (e += t.id),
        ...
        },
        {
          ...
          value(t) {
            const e = _t(t);
            const n = this.encodeAsString(e.packet);
            const r = e.buffers;
        ...
        [
          {
            ...
            value(t) {
              ...
              if (typeof t === 'string') {
                ...
                const n = (e = this.decodeString(t)).type === Rt.BINARY_EVENT;
                n || e.type === Rt.BINARY_ACK
                  ? ((e.type = n ? Rt.EVENT : Rt.ACK),
                    (this.reconstructor = new Nt(e)),
                    e.attachments === 0 && p(s(i.prototype), 'emitReserved', this).call(this, 'decoded', e))
                  : p(s(i.prototype), 'emitReserved', this).call(this, 'decoded', e);
              } else {
                if (!kt(t) && !t.base64) throw new Error(`Unknown type: ${t}`);
                if (!this.reconstructor) throw new Error('got binary data when not reconstructing a packet');
                (e = this.reconstructor.takeBinaryData(t)) &&
                  ((this.reconstructor = null), p(s(i.prototype), 'emitReserved', this).call(this, 'decoded', e));
              }
            },
          },
          {
            ...
            value(t) {
              ...
              if (void 0 === Rt[n.type]) throw new Error(`unknown packet type ${n.type}`);
              ...
              if (t.charAt(++e)) {
                const h = this.tryParse(t.substr(e));
            ...
            value(t, e) {
              switch (t) {
                ...
                case Rt.BINARY_EVENT:
                  return (
                    Array.isArray(e) &&
                    (typeof e[0] === 'number' || (typeof e[0] === 'string' && Tt.indexOf(e[0]) === -1))
                  );
                case Rt.ACK:
                case Rt.BINARY_ACK:
    ...
    return (
      r(a, [
        ...
        },
        {
          key: 'emit',
          value(t) {
            if (Pt.hasOwnProperty(t)) throw new Error(`"${t.toString()}" is a reserved event name`);
            for (var e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), r = 1; r < e; r++) n[r - 1] = arguments[r];
            if ((n.unshift(t), this._opts.retries && !this.flags.fromQueue && !this.flags.volatile)) return this._addToQueue(n), this;
            const i = { type: Rt.EVENT, data: n, options: {} };
            if (((i.options.compress = !1 !== this.flags.compress), typeof n[n.length - 1] === 'function')) {
              const o = this.ids++;
              const s = n.pop();
        ...
        },
        {
          ...
          value(t, e) {
            let n;
            const r = this;
            const i = (n = this.flags.timeout) !== null && void 0 !== n ? n : this._opts.ackTimeout;
            if (void 0 !== i) {
              const o = this.io.setTimeoutFn(() => {
                delete r.acks[t];
                for (let n = 0; n < r.sendBuffer.length; n++) r.sendBuffer[n].id === t && r.sendBuffer.splice(n, 1);
        ...
        },
        {
          ...
          value(t) {
            ...
            return new Promise((n, i) => {
              r.push((t, e) => (o ? (t ? i(t) : n(e)) : n(t))), e.emit.apply(e, [t].concat(r));
            });
          },
        },
        {
        ...
        },
        {
          ...
          value(t) {
            this.packet({ type: Rt.CONNECT, data: this._pid ? i({ pid: this._pid, offset: this._lastOffset }, t) : t });
          },
        },
        {
          key: 'onerror',
        ...
        },
        {
          ...
          value(t) {
            if (this._anyListeners && this._anyListeners.length) {
              let e;
              const n = y(this._anyListeners.slice());
              try {
                for (n.s(); !(e = n.n()).done;) {
        ...
        },
        {
          ...
          value() {
            const t = this;
            this.receiveBuffer.forEach(e => t.emitEvent(e)),
              (this.receiveBuffer = []),
        ...
        },
        {
          ...
          value(t) {
            ...
            if (t) {
              for (let e = this._anyListeners, n = 0; n < e.length; n++) if (t === e[n]) return e.splice(n, 1), this;
            } else {
              this._anyListeners = [];
            }
            return this;
        ...
        },
        {
          ...
          value(t) {
            return (
              (this._anyOutgoingListeners = this._anyOutgoingListeners || []), this._anyOutgoingListeners.push(t), this
            );
          },
        },
        {
        ...
        },
        {
          ...
          value(t) {
            ...
            if (t) {
              for (let e = this._anyOutgoingListeners, n = 0; n < e.length; n++) if (t === e[n]) return e.splice(n, 1), this;
            } else {
        ...
        },
        {
          ...
          value(t) {
            if (this._anyOutgoingListeners && this._anyOutgoingListeners.length) {
              let e;
              const n = y(this._anyOutgoingListeners.slice());
              try {
                for (n.s(); !(e = n.n()).done;) {
  ...
  const It = (function(n) {
    ...
    function s(n, r) {
      ...
      e(this, s),
        ...
        o.randomizationFactor((a = r.randomizationFactor) !== null && void 0 !== a ? a : 0.5),
        (o.backoff = new qt({
          min: o.reconnectionDelay(),
          max: o.reconnectionDelayMax(),
          jitter: o.randomizationFactor(),
        })),
        o.timeout(r.timeout == null ? 2e4 : r.timeout),
      ...
      r(s, [
        ...
        },
        {
          ...
          value(t) {
            ...
            return void 0 === t
              ...
              : ((this._reconnectionDelay = t), (e = this.backoff) === null || void 0 === e || e.setMin(t), this);
          },
        },
        {
          ...
          value(t) {
            ...
            return void 0 === t
              ...
              : ((this._randomizationFactor = t), (e = this.backoff) === null || void 0 === e || e.setJitter(t), this);
          },
        },
        {
          ...
          value(t) {
            ...
            return void 0 === t
              ...
              : ((this._reconnectionDelayMax = t), (e = this.backoff) === null || void 0 === e || e.setMax(t), this);
          },
        },
        {
          key: 'timeout',
        ...
        },
        {
          ...
          value(t, e) {
            let n = this.nsps[t];
            return (
              n ? this._autoConnect && !n.active && n.connect() : ((n = new jt(this, t, e)), (this.nsps[t] = n)), n
            );
          },
        },
        {
        ...
        },
        {
          key: '_packet',
          value(t) {
            for (let e = this.encoder.encode(t), n = 0; n < e.length; n++) this.engine.write(e[n], t.options);
          },
        },
        {
          key: 'cleanup',
