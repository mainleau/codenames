...
!(function(t, e) {
    ...
    function h(t) {
        ...
        return (
            (h = function (t) {
                if (
                    t === null ||
                    ((n = t), Function.toString.call(n).indexOf('[native code]') === -1)
                )
                    return t;
                var n;
                        ...
                        value: function (t) {
                            var e =
                                arguments.length > 1 && void 0 !== arguments[1]
                                    ? arguments[1]
                                    : {};
                            return `${t}://${this._hostname()}${this._port()}${
                                this.opts.path
                            }${this._query(e)}`;
                        },
                    },
    ...
    function Z(t) {
        var e = t.xdomain;
        try {
            if (typeof XMLHttpRequest !== 'undefined' && (!e || G))
    ...
    function tt() {}
    var et = new Z({ xdomain: !1 }).responseType != null,
        nt = (function (t) {
            o(s, t);
            var n = l(s);
            function s(t) {
    ...
    var yt = typeof ArrayBuffer === 'function',
        vt = function (t) {
            return typeof ArrayBuffer.isView === 'function'
                ? ArrayBuffer.isView(t)
        ...
        mt =
            typeof Blob === 'function' ||
            (typeof Blob !== 'undefined' && gt.call(Blob) === '[object BlobConstructor]'),
        bt =
            typeof File === 'function' ||
            (typeof File !== 'undefined' && gt.call(File) === '[object FileConstructor]');
    function kt(t) {
        return (
    ...
    function wt(e, n) {
        ...
        for (var o in e) if (Object.hasOwn(e, o) && wt(e[o])) return !0;
        return !1;
    }
    function _t(t) {
        var e = [],
    ...
    function Ot(e, n) {
        ...
        if (t(e) === 'object' && !(e instanceof Date)) {
            var s = {};
            for (var a in e) Object.hasOwn(e, a) && (s[a] = Ot(e[a], n));
            return s;
        }
        return e;
    }
    ...
    function Et(e, n) {
        ...
        if (Array.isArray(e)) {
            for (var r = 0; r < e.length; r++) e[r] = Et(e[r], n);
        } else if (t(e) === 'object') {
            for (var i in e) Object.hasOwn(e, i) && (e[i] = Et(e[i], n));
        }
        return e;
    }
    var Rt,
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                if (
                                    n.type === Rt.BINARY_EVENT ||
                                    n.type === Rt.BINARY_ACK
                                ) {
                                    for (
                                        var r = e + 1;
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            var n,
                                r = this,
                                i =
                                    (n = this.flags.timeout) !== null && void 0 !== n
                                        ? n
            ...
            function s(n, r) {
                ...
                e(this, s),
                    ...
                    o.randomizationFactor(
                        (a = r.randomizationFactor) !== null && void 0 !== a ? a : 0.5,
                    ),
                    (o.backoff = new qt({
        ...
        var r,
            i = (function (t) {
                ...
                (n = n || (typeof location !== 'undefined' && location)),
                    ...
                    (r.path = r.path || '/');
                var i = r.host.indexOf(':') !== -1 ? `[${r.host}]` : r.host;
                return (
