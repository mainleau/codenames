...
export default class Manager {
  constructor(app) {
    ...
    const options = {
      timeout: 15_000,
      cdn: location.hostname !== 'localhost' ? 'https://cdn.nomdecode.fun' : 'http://localhost:8886',
      api: {
        games: location.hostname !== 'localhost' ? 'https://api-games.nomdecode.fun' : 'http://localhost:8887',
        core: location.hostname !== 'localhost' ? 'https://api-core.nomdecode.fun' : 'http://localhost:8888',
        auth: location.hostname !== 'localhost' ? 'https://api-auth.nomdecode.fun' : 'http://localhost:8889',
      },
    };
