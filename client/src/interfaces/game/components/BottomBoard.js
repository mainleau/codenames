...
export default class BottomBoard extends Component {
  ...
  create() {
    ...
    clueCountContainer.onclick = () => {
      ...
      clueCountSelector.style.visibility = clueCountSelector.style.visibility === 'hidden' ? 'visible' : 'hidden';
    };
    ...
    giveClueCTA.onclick = () => {
      this.game.emit('give-clue', {
        ...
        count: !isNaN(clueCountText.textContent) ? parseInt(clueCountText.textContent) : clueCountText.textContent,
      });
    };
